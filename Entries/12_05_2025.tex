...
\begin{itemize}
	\item Página para convertir voltaje pico a pico a RMS y vice-versa: \url{https://www.allaboutcircuits.com/tools/peak-to-peak-voltage-calculator/}
	\item Página para calcular la frecuncia $f$ y factor de calidad $Q$ de un circuito RLC simple en serie: \url{https://www.omnicalculator.com/physics/rlc-circuit} % $ {} . : 
\end{itemize}
