...
\begin{figure}[!ht]
	...
	\end{minipage}\begin{minipage}[c]{0.49\textwidth}
		...
		\end{subfigure}
	\end{minipage}
	\caption{PDFs para las fases de las señales de turbulencia de ondas calculadas con ventanas en frecuencia de la FFT de ña señal completa, usando ventana Tukey de parámetro $\alpha=0.01$.}
