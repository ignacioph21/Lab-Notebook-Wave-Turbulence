...
\begin{figure}[!ht]
	\begin{minipage}[c]{0.5\textwidth}
			\begin{subfigure}{\textwidth}
					\centering
					\includegraphics[width=0.8\textwidth]{Figures/21_04_2025/Diseño_conector.jpg}
					\captionsetup{width=0.8\textwidth}
					\subcaption{Posicionamiento de las partes.}
				\end{subfigure}
		...
		\end{minipage}\begin{minipage}[c]{0.249\textwidth}
			...
			\end{subfigure}
		\end{minipage}
	\caption{Fotos de las partes relevantes para el conector tornillo micrométrico - perfil.} % a 
	\label{fig:}
\end{figure}
